...
const contents = {
  reads: [
    ...
    { id: 5, title: "L'Homme le plus riche de Babylone", author: "George S. Clason", cover: "https://images.unsplash.com/photo-1614849963640-9cc74b2a826f?w=400", fileUrl: "/books/babylone.pdf", type: "pdf" },
