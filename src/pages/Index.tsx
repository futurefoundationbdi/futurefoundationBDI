...
préfèrent ignorer.</p>
                <p>On y sent la spontanéité de quelqu’un qui cherche à apprendre autant qu’à transmettre, et c’est précisément ce qui rend cet ouvrage inspirant. Il ne prétend pas offrir toutes les réponses ni rivaliser avec les grands manuels Préface d’économie ; il ouvre plutôt une porte, celle de la découverte et de la réflexion personnelle. Bien sûr, certaines explications pourraient gagner à être enrichies par des recherches plus 
approfondies, par des lectures, des expériences et des conseils d’experts. Mais faut-il déjà tout maîtriser pour commencer à écrire, à partager et à 
